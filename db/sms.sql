...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `apiusername` varchar(30) NOT NULL,
  `apipassword` varchar(30) NOT NULL,
...
INSERT INTO `member` (`mem_id`, `username`, `password`, `apiusername`, `apipassword`, `location`, `serial`, `longitude`, `latitude`) VALUES
(1,'machette','3456345654366463','demo','demo','Nairobi','11345454545','35.929673','-78.948237');
